...
def test_scissors_beats_paper():
    return assert_print(
        rps("scissors", "paper") == "Scissors win!", "scissors beats paper"
    )


def test_tie():
    return assert_print(rps("rock", "rock") == "It's a tie!", "its a tie")

    ##


def test_tie_scissors():
    return assert_print(rps("scissors", "scissors") == "It's a tie!", "its a tie")


def test_tie_paper():
    return assert_print(rps("paper", "paper") == "It's a tie!", "its a tie")
...
def test_scissors_beats_paper_flipped():
    return assert_print(
        rps("paper", "scissors") == "Scissors win!", "scissors beats paper"
    )
